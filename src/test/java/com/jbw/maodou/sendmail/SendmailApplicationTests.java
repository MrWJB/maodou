package com.jbw.maodou.sendmail;

import com.jbw.maodou.service.sendmail.MailService;
...
public class SendmailApplicationTests {
    ...
    public void sendMailWithImg() {
        mailService.sendMailWithImg("1310548622@qq.com",
                "1812121918@qq.com",
                "测试邮件主题(图片)",
                "<div>hello,这是一封带图片资源的邮件：" +
                        ...
                        "</div>",
                new String[]{"/Users/jibinwang/Pictures/maodou1.jpeg",
                        "/Users/jibinwang/Pictures/maodou2.jpeg"},
                new String[]{"p01", "p02"});
    }
